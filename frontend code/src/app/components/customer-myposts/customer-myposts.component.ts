...
@Component({
  selector: 'app-customer-myposts',
  imports: [FormsModule, NgFor, NgIf],
  templateUrl: './customer-myposts.component.html',
  styleUrl: './customer-myposts.component.css'
})
export class CustomerMypostsComponent {
    ...
    navigateToCommentsPage(postId: any): void {
      ...
      this.router.navigate(['/customer/customer-posts/post-comments']);
    }
    ...
    fetchPosts(): void {
      this.postService.getPostsByUserId(localStorage.getItem('id')).subscribe({
        next: (data) => {
          console.log(data);
          this.posts = data;
        },
