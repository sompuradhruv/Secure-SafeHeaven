...
@Component({
  selector: 'app-cutomer-post-comments',
  imports: [FormsModule, NgFor, NgIf],
  templateUrl: './cutomer-post-comments.component.html',
  styleUrl: './cutomer-post-comments.component.css'
})
export class CutomerPostCommentsComponent {
